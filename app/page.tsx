      ...
      <footer className="bg-gradient-to-br from-gray-900 via-slate-900 to-gray-900 text-white">
        ...
        <a
          ...
          rel="noopener noreferrer"
            ...
            {/* Developer Info */}
            <div>
              <h4 className="text-lg font-bold mb-6 bg-gradient-to-r from-white to-blue-100 bg-clip-text text-transparent">Website Developer</h4>
              <div className="space-y-4">
                <div className="flex items-start">
                  <div className="w-5 h-5 mt-1 mr-3 text-purple-400">
                    <svg fill="currentColor" viewBox="0 0 20 20">
                      <path fillRule="evenodd" d="M12.316 3.051a1 1 0 01.633 1.265l-4 12a1 1 0 11-1.898-.632l4-12a1 1 0 011.265-.633zM5.707 6.293a1 1 0 010 1.414L3.414 10l2.293 2.293a1 1 0 11-1.414 1.414l-3-3a1 1 0 010-1.414l3-3a1 1 0 011.414 0zm8.586 0a1 1 0 011.414 0l3 3a1 1 0 010 1.414l-3 3a1 1 0 11-1.414-1.414L16.586 10l-2.293-2.293a1 1 0 010-1.414z" clipRule="evenodd"/>
                    </svg>
                  </div>
                  <div>
                    <p className="text-gray-300 font-semibold">Lawmwad Technologies</p>
                    <a href="https://lawmwad.vercel.app/" target="_blank" rel="noopener noreferrer" className="text-blue-400 hover:text-blue-300 transition-colors duration-300 text-sm">lawmwad.vercel.app</a>
                  </div>
                </div>
                <div className="flex items-start">
                  <div className="w-5 h-5 mt-1 mr-3 text-green-400">
                  ...
                  <div>
                    <a href="https://wa.me/256758951822" target="_blank" rel="noopener noreferrer" className="text-gray-300 hover:text-white transition-colors duration-300">+256 758 951 822</a>
                  </div>
                </div>
                <div className="flex items-start">
                  <div className="w-5 h-5 mt-1 mr-3 text-green-400">
                  ...
                  <div>
                    <a href="https://wa.me/256745033924" target="_blank" rel="noopener noreferrer" className="text-gray-300 hover:text-white transition-colors duration-300">+256 745 033 924</a>
                  </div>
                </div>
              </div>
            </div>
